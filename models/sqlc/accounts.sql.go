...
VALUES($1,$2,$3,$4,$5,$6)
RETURNING uid, transaction_id, account_id, other_account, amount, currency, type, created_at
`
...
VALUES($1,$2,$3,$4,$5)
RETURNING uid, transaction_id, from_account_id, to_account_id, amount, currency, created_at
`
